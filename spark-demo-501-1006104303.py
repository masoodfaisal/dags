...
args = {
    "project_id": "spark-demo-501-1006104303",
}

dag = DAG(
    "spark-demo-501-1006104303",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using spark-demo-501.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="spark-demo-501-1006104303",
...
notebook_op_8628c8ac_380d_4460_aa1e_506ffd6b010b = NotebookOp(
    ...
    image="image-registry.openshift-image-registry.svc:5000/anz-ml/elyra-spark:0.0.3",
    in_cluster=True,
    env_vars={
        "AWS_ACCESS_KEY_ID": "minio",
        "AWS_SECRET_ACCESS_KEY": "minio123",
...
notebook_op_91a3738b_783b_4eb6_823c_1b8b013a4d51 = NotebookOp(
    ...
    env_vars={
        ...
        "AWS_SECRET_ACCESS_KEY": "minio123",
        "ELYRA_ENABLE_PIPELINE_INFO": "True",
        "S3_ENDPOINT": "http://minio-ml-workshop:9000",
    },
    config_file="None",
    dag=dag,
)
