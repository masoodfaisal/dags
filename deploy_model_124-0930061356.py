...
args = {
    "project_id": "deploy_model_124-0930061356",
}

dag = DAG(
    "deploy_model_124-0930061356",
    default_args=args,
...
op_9717753b_c990_4c21_88ba_4a46474a32e4 = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "deploy_model_124-0930061356-{{ ts_nodash }}",
    },
    in_cluster=True,
    config_file="None",
    dag=dag,
