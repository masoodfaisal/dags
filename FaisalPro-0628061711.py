...
args = {
    "project_id": "FaisalPro-0628061711",
}

dag = DAG(
    "FaisalPro-0628061711",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.1 pipeline editor using FaisalPro.pipeline.",
...
notebook_op_aa7497ee_b8eb_4493_ad05_89cd74ac4389 = NotebookOp(
    ...
    cos_bucket="data",
    cos_directory="FaisalPro-0628061711",
