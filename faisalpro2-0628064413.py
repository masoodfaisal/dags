...
args = {
    "project_id": "faisalpro2-0628064413",
}

dag = DAG(
    "faisalpro2-0628064413",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.1 pipeline editor using faisalpro2.pipeline.",
...
notebook_op_aa7497ee_b8eb_4493_ad05_89cd74ac4389 = NotebookOp(
    ...
    cos_bucket="data",
    cos_directory="faisalpro2-0628064413",
