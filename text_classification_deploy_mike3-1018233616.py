...
args = {
    "project_id": "text_classification_deploy_mike3-1018233616",
}

dag = DAG(
    "text_classification_deploy_mike3-1018233616",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using text_classification_deploy_mike3.pipeline.",
...
notebook_op_4879d246_135e_46a2_b36b_01a01ecc22fb = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="text_classification_deploy_mike3-1018233616",
    cos_dependencies_archive="ocp_deploy-4879d246-135e-46a2-b36b-01a01ecc22fb.tar.gz",
    pipeline_outputs=[],
    pipeline_inputs=[],
    image="registry.access.redhat.com/ubi8/python-38:1-71",
    in_cluster=True,
    env_vars={
        "AWS_ACCESS_KEY_ID": "minio",
        "AWS_SECRET_ACCESS_KEY": "minio123",
        "ELYRA_ENABLE_PIPELINE_INFO": "True",
        "MODEL_NAME": "mike-ltsm-1",
        "MODEL_VERSION": "1",
    },
    config_file="None",
    dag=dag,
