...
args = {
    "project_id": "text_classification_deploy_model_v101-1012071054",
}

dag = DAG(
    "text_classification_deploy_model_v101-1012071054",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using text_classification_deploy_model_v101.pipeline.",
...
notebook_op_4879d246_135e_46a2_b36b_01a01ecc22fb = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="text_classification_deploy_model_v101-1012071054",
