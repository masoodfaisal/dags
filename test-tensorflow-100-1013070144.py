...
args = {
    "project_id": "test-tensorflow-100-1013070144",
}

dag = DAG(
    "test-tensorflow-100-1013070144",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using test-tensorflow-100.pipeline.",
...
notebook_op_32a32b67_af9e_41f0_a74e_c615d6f07643 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="test-tensorflow-100-1013070144",
