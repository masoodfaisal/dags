...
args = {
    "project_id": "spark-demo-1000-1014023732",
}

dag = DAG(
    "spark-demo-1000-1014023732",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using spark-demo-1000.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="spark-demo-1000-1014023732",
    ...
    env_vars={
        ...
        "WORKER_NODES": "2",
        "PIPY_REPO_URL": "https://pypi.python.org/pypi",
    },
    config_file="None",
    dag=dag,
)
