...
args = {
    "project_id": "sa_deploy_2-1004020744",
}

dag = DAG(
    "sa_deploy_2-1004020744",
    default_args=args,
...
op_9717753b_c990_4c21_88ba_4a46474a32e4 = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "sa_deploy_2-1004020744-{{ ts_nodash }}",
    },
    in_cluster=True,
    config_file="None",
    dag=dag,
