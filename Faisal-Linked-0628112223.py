...
args = {
    "project_id": "Faisal-Linked-0628112223",
}

dag = DAG(
    "Faisal-Linked-0628112223",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.1 pipeline editor using Faisal-Linked.pipeline.",
...
notebook_op_aa7497ee_b8eb_4493_ad05_89cd74ac4389 = NotebookOp(
    ...
    cos_bucket="data",
    cos_directory="Faisal-Linked-0628112223",
