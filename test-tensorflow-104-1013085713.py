...
args = {
    "project_id": "test-tensorflow-104-1013085713",
}

dag = DAG(
    "test-tensorflow-104-1013085713",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using test-tensorflow-104.pipeline.",
...
notebook_op_32a32b67_af9e_41f0_a74e_c615d6f07643 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="test-tensorflow-104-1013085713",
    cos_dependencies_archive="untitled-32a32b67-af9e-41f0-a74e-c615d6f07643.tar.gz",
    pipeline_outputs=[],
    pipeline_inputs=[],
    image="quay.io/ml-aml-workshop/airflow-python-runner:0.0.10",
    in_cluster=True,
    env_vars={
