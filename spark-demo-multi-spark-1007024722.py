...
args = {
    "project_id": "spark-demo-multi-spark-1007024722",
}

dag = DAG(
    "spark-demo-multi-spark-1007024722",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using spark-demo-multi-spark.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="spark-demo-multi-spark-1007024722",
...
notebook_op_2f11f50f_cf77_4dbc_9f7b_93f4d9764a4a = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="spark-demo-multi-spark-1007024722",
    cos_dependencies_archive="start-spark-cluster-2f11f50f-cf77-4dbc-9f7b-93f4d9764a4a.tar.gz",
    pipeline_outputs=[],
    pipeline_inputs=[],
    image="quay.io/ml-aml-workshop/airflow-python-runner:0.0.5",
    in_cluster=True,
...
notebook_op_0297de3c_970e_4e8b_8e6d_674904d541b2 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="spark-demo-multi-spark-1007024722",
    cos_dependencies_archive="stop-spark-cluster-0297de3c-970e-4e8b-8e6d-674904d541b2.tar.gz",
    pipeline_outputs=[],
    pipeline_inputs=[],
    image="quay.io/ml-aml-workshop/airflow-python-runner:0.0.5",
    in_cluster=True,
